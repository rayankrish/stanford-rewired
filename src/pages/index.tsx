    ...
    <div>
      ...
      <div className="columns">
        <div className="col">
          ...
          <p>We’re currently accepting submissions for our Fall 2020 issue. The theme is Governance. <a href="https://www.notion.so/stanfordrewired/Stanford-Rewired-Open-Submission-932ab29333e34525b2a775e5a0a9fe5a" target="_blank">You can learn more about our submission process here.</a></p>
        </div>
        <div className="col">
