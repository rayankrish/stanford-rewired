...
function Dots1() {
  return (
    <svg className="svgContainer" id="dots1" width="482" height="201" viewBox="0 0 482 201" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function Dots2() {
  return (
    <svg className="svgContainer" id="dots2" width="88" height="88" viewBox="0 0 88 88" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function Dots3() {
  return (
    <svg className="svgContainer" id="dots3" width="88" height="643" viewBox="0 0 88 643" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function Dots4() {
  return (
    <svg className="svgContainer" id="dots4" width="88" height="312" viewBox="0 0 88 312" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="72" cy="296" r="16"/>
      <circle cx="72" cy="184" r="16"/>
      <circle cx="72" cy="72" r="16"/>
      <circle cx="16" cy="296" r="16"/>
...
function Dots5() {
  return (
    <svg className="svgContainer" id="dots5" width="88" height="88" viewBox="0 0 88 88" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="16" cy="16" r="16"/>
    <circle cx="72" cy="16" r="16"/>
    <circle cx="16" cy="72" r="16"/>
    <circle cx="72" cy="72" r="16"/>
